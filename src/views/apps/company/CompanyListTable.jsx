  ...
  return (
    <>
      ...
      <AddUserDrawer
        ...
        setData={setData}
      />
      <ViewUserDrawer open={openViewDrawer} handleClose={() => setViewUserOpen(!viewUserOpen)} userId={viewUserId} />
      <UpdateUserDrawer open={openUpdateDrawer} handleClose={() => setUpdateUserOpen(!editUserOpen)} user={userData} />
    </>
  )
}
